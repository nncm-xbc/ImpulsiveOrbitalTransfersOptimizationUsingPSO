...
template <typename T, typename Fun> vector<T> &Particle<T, Fun>::getPosition() {
  return _position;
}

template <typename T, typename Fun> vector<T> &Particle<T, Fun>::getVelocity() {
  return _velocity;
}
...
template <typename T, typename Fun> void Particle<T, Fun>::info() const {
  cout << "Position     : ";
